...
public class AnimalDaoImpl implements AnimalDao {
    ...
    @Override
    public void createTable() throws SQLException { //Creare tabel
    ...
    public void create(Animal animal) throws SQLException {
        PreparedStatement preparedStatement = connection.prepareStatement("insert into animals (name, species) values (?,?)");
    ...
    @Override
    public void dropTable() throws SQLException { // stergere tabel
        Statement statement = connection.createStatement();
